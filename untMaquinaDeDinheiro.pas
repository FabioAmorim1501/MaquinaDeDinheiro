...
function TTroco.MontarTroco(Troco: Double): TList;
var
  ListaTroco: TList;
...
begin
  ...
  begin
    ...
    ValorTrocoRestante := (Round(ValorTrocoRestante * 100) mod 25) / 100;
  end;
  if ValorTrocoRestante >= 10 then
  begin
